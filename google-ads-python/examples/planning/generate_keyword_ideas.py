...
_DEFAULT_LOCATION_IDS = ["1000126"]  # location ID for New York, NY
...
_DEFAULT_LANGUAGE_ID = "1003"  # language ID for English
...
if __name__ == "__main__":
    ...
    googleads_client = GoogleAdsClient.load_from_storage('D:/api/google-ads-python/google-ads.yaml', version="v8")
